...
<div class="container-add-abono">
    ...
    <!-- FORMULARIO -->
    <div>
        <form id="form-abono" method="post" action="index.php?action=register.fitosanitario">
            ...
            <div class="">
                <?php
                echo '<input type="hidden" id="idfitosanitario" name="idfitosanitario" value="' . $dataForm["id"] . '">';
